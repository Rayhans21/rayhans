      ...
      <div className='max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center md:items-center justify-center md:justify-between gap-16'>
        <div className='relative w-full md:w-1/2 flex justify-center md:justify-end'>
          <div className='relative w-[280px] md:w-[340px]'>
            ...
            <h1 className='absolute -left-4 md:-left-16 bottom-[45px] text-white font-bold leading-[0.95] tracking-tight drop-shadow-[0_8px_20px_rgba(0,0,0,0.6)] text-6xl md:text-8xl'>
              Rayhan
        ...
        <div className='w-full md:w-1/2 mt-10 md:mt-0'>
          ...
          <div className='flex gap-6 items-center mb-4'>
            <a href='#projects' className='text-yellow-400 font-medium text-base hover:text-yellow-300'>
              Explore My Work →
            </a>
          </div>
        </div>
